...
**文件：** `vins_estimator/src/featureTracker/feature_tracker.h`
...
**文件：** `vins_estimator/src/featureTracker/feature_tracker_matcher.h`
...
**文件：** `vins_estimator/src/featureTracker/feature_tracker_matcher.cpp`
...
**文件：** `vins_estimator/src/featureTracker/feature_tracker.cpp` — `initDetectorAndMatcher()`
...
**文件：** `vins_estimator/src/featureTracker/feature_tracker.cpp`（第 337-529 行）
...
**文件：** `vins_estimator/src/featureTracker/feature_tracker.cpp`
...
**文件：** `vins_estimator/src/featureTracker/feature_tracker.cpp` — `drawTrackPolar()`
...
| 文件 | 改动内容 |
|------|---------|
| `vins_estimator/src/featureTracker/feature_tracker.h` | `ChannelState` 添加右目字段 |
| `vins_estimator/src/featureTracker/feature_tracker.cpp` | 重写 `trackImage()`、更新 `removeOutliers()`、更新 `drawTrackPolar()` |
| `vins_estimator/src/featureTracker/feature_tracker_matcher.h` | 添加 `stereoMatch()` 虚方法 |
| `vins_estimator/src/featureTracker/feature_tracker_matcher.cpp` | 实现 `LKFlowMatcher::stereoMatch()` |
